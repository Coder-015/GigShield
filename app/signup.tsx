...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 14, color: '#A1A1AA', marginBottom: 32, lineHeight: 20 },
  label: { fontSize: 13, fontWeight: '600', color: '#D4D4D8', marginBottom: 8, marginTop: 16, letterSpacing: 0.5, textTransform: 'uppercase' },
  input: {
  ...
  arrow: { fontSize: 12, color: '#A1A1AA' },
  button: {
  ...
  loginText: { fontSize: 14, color: '#A1A1AA' },
  ...
  modalItemText: { fontSize: 16, color: '#A1A1AA' },
